...
5. **理解阶段汇总**：参考 [[a2数据分析师agent阶段汇总|`Appendix/数据分析师agent阶段汇总.md`]] 了解多阶段协作机制
...
- **[[multi-agent-workflow-framework/Appendix/a2数据分析师agent阶段汇总\|数据分析师agent阶段汇总.md]]** - 各阶段结果汇总与业务框架维护过程
