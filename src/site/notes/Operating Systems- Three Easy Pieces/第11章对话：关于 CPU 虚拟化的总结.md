---
{"dg-publish":true,"permalink":"/operating-systems-three-easy-pieces/11-cpu/","noteIcon":""}
---
...
**学生：** 但你不就是这样想的吗？ 让我们对某些事感到兴奋，这样我们就会自己对它进行研究？ 点燃火，仅此而已？
...
CPU 虚拟化的核心机制（受限直接执行、时钟中断、上下文切换）和调度策略（MLFQ、比例份额）已经讲完。你现在应该建立了这样的认知：操作系统既是"偏执的资源控制者"，也是"美丽的假象制造者"。

下一章将开启虚拟化的另一半——**内存虚拟化**。如果说 CPU 虚拟化靠的是"时分共享"，那内存虚拟化靠的是"地址转换"——这将是更复杂、更精彩的旅程。

[[Operating Systems- Three Easy Pieces/📍 MOC - 《操作系统导论》深度知识架构\|MOC]] · [[Operating Systems- Three Easy Pieces/第12章对话：关于内存虚拟化\|下一章：Ch12对话 内存虚拟化]]